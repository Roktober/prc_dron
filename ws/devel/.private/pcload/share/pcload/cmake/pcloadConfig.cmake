...
if("TRUE" STREQUAL "TRUE")
  set(pcload_SOURCE_PREFIX /home/roktober/git_fulab/ws/src/pcload)
  set(pcload_DEVEL_PREFIX /home/roktober/git_fulab/ws/devel/.private/pcload)
  set(pcload_INSTALL_PREFIX "")
  set(pcload_PREFIX ${pcload_DEVEL_PREFIX})
else()
  set(pcload_SOURCE_PREFIX "")
  set(pcload_DEVEL_PREFIX "")
  set(pcload_INSTALL_PREFIX /home/roktober/git_fulab/ws/install)
...
if(NOT "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/x86_64-linux-gnu;/usr/include/jsoncpp;/usr/include/tcl;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7 " STREQUAL " ")
  set(pcload_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/x86_64-linux-gnu;/usr/include/jsoncpp;/usr/include/tcl;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/python2.7")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pcload' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/roktober/git_fulab/ws/src/pcload/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/roktober/git_fulab/ws/devel/.private/pcload/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND pcload_EXPORTED_TARGETS ${${pcload_dep}_EXPORTED_TARGETS})
endforeach()
